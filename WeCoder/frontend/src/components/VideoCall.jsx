...
// const TEMP_TOKEN = "007eJxTYCjIZxY99zaNM+W4UOwSnkqJ+BfHXkeKlH7ecr9l9pHdHDMVGMwszA0NLdNMzNMsjEzMkowtLJPMkkwMjSwMk80NU8wtc7LL0hsCGRlszCwYGKEQxGdhyE3MzGNgAADtrh11"; // Replace with your Agora Temporary Token
...
const CHANNEL = "main"; // Replace with your channel name // Replace with your channel name
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100">
      {!joined ? (
        ...
        <div className="space-x-4">
          <button
            className="bg-red-500 bgcolor-yellow text-white py-2 px-4 rounded hover:bg-red-600"
            onClick={leaveStream}
          >
            Leave Stream
          </button>
          <button
            className={`bg-${audioEnabled ? "red" : "yellow"}-500 text-white py-2 px-4 rounded hover:bg-${audioEnabled ? "red" : "cyan"}-600`}
            onClick={toggleAudio}
          >
          ...
          <button
            className={`bg-${videoEnabled ? "red" :  "yellow"}-500 text-white py-2 px-4 rounded hover:bg-${videoEnabled ? "red" : "cyan"}-600`}
            onClick={toggleVideo}
          >
